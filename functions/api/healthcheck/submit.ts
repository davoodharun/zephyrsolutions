...
4. Top Risks: 2-5 items. Each must have a specific title (e.g. "Lack of automated backups", "Single point of failure for IT") and a concrete description explaining the risk—never "Risk" or "See assessment."
5. Top Priorities: 2-4 items. Each must have a specific title and description of what to do and why—never "Priority" or "See assessment."
6. Do Not Worry Yet: 1-3 items. Each must name a specific area (e.g. "Current email setup") and briefly why it's acceptable—never generic "Item" or "Acceptable for now."
7. Next Steps: 3-6 concrete steps. Each must have a specific title (e.g. "Schedule a backup review"), a short description, and a realistic timeline—never "Step" or "See assessment." or "Soon" alone.
