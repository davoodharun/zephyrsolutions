...
const submissionSchema = {
  ...
  "properties": {
    ...
    "backups_maturity": { "type": "string", "enum": ["none", "basic", "regular", "automated", "cloud-based", "not_sure"] },
    "security_confidence": { "type": "string", "enum": ["very_low", "low", "moderate", "high", "very_high", "not_sure"] },
